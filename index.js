...
const duniter_1 = require("duniter");
 ...
 * SPECIALIZATION
 ***************************************/
const stack = duniter_1.Statics.autoStack([{
        name: 'remuniter',
        required: {
            duniter: {
                cliOptions: [
                ...
                cli: [{
                        ...
                        logs: false,
                        onDatabaseExecute: async (server, conf, program, params, startServices) => {
                            /****************************************
                            ...
                            // Remuniter
                            try {
                                await main_1.main(server, SERVER_HOST, SERVER_PORT, payperiod, paychunk, paystart, payperblock);
                            }
                            catch (err) {
